    ...
    return (
        <div className="flex items-center text-[20px] gap-[8px] py-[8px] px-[22px] ml-auto text-[#454F55] bg-[#EBEBEB] rounded-md w-[510px]">
            ...
            >
                <span>{label}</span>
                <div className="">
                    <div className={`border-2 rounded mr-2 flex items-center justify-center`}>
                    {checked? (
                        ...
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="40" height="40" rx="7" fill="#EBEBEB"/>
                            <rect x="-1" y="1" width="28" height="28" rx="6" transform="matrix(-1 0 0 1 33 5)" fill="#EBEBEB" stroke="#9AA8B0" stroke-width="2"/>
                        </svg>
